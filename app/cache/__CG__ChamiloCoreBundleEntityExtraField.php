...
class ExtraField extends \Chamilo\CoreBundle\Entity\ExtraField implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'extraFieldType', 'fieldType', 'variable', 'displayText', 'defaultValue', 'fieldOrder', 'visible', 'changeable', 'filter', 'options', 'createdAt', 'type', 'name', 'configuration', 'updatedAt', 'translations', 'currentLocale', 'currentTranslation', 'fallbackLocale');
        }
    ...
    public function getDisplayText()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDisplayText', array());
